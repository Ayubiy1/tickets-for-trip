...
const HeaderComp = () => {
    const [choosedWay, setChoosedWay] = useState("fly")

    return <>
        <div className="bg-[#05203c] py-5 px-5 lg:px-15 xl:px-25">
            <div className="flex items-center justify-between fill-[#fff] text-[#fff]">
                <svg
            ...
            <div className="flex items-center gap-3 text-white fhc mt-6 ">
                <span
                    onClick={() => {
                        setChoosedWay("fly")
                    }}
                    className={`flex items-center gap-1 way ${choosedWay == "fly" && "span-active"}`}
                >
                    <RiFlightTakeoffLine />
                    Flights
                </span>
                <span
                    onClick={() => {
                        setChoosedWay("hotels")
                    }}
                    className={`flex items-center gap-1 way ${choosedWay == "hotels" && "span-active"}`}
                >
                    <IoBed />
                    Hotels
                </span>
                <span
                    ...
                    className={`flex items-center gap-1 way ${choosedWay == "cars" && "span-active"}`}
                >
                    <GiCityCar />
                    Cars Reantal
                </span>
